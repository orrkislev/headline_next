...
export default function ArchiveCountryNavigator({ country, locale, year, month }) {
    ...
    return (
        <div className="relative z-[1000]" ref={dropdownRef}>
            ...
            <ArchiveCountrySelector {...{ country, open, locale, year, month }} close={() => setOpen(false)} />
        </div>
    );
}

function ArchiveCountrySelector({ country, open, close, locale, year, month }) {
        ...
        <div className={`${
            ...
            <div className="grid grid-cols-2 gap-[1px] bg-gray-200">
                {Object.keys(countries)
                    ...
                    .map((c, i) => (
                        <InnerLink key={i} locale={locale} href={`/${locale}/${c}/history/${year}/${month.toString().padStart(2, '0')}`}>
